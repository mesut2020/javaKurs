 ...
 */
    ...
    public void LetsGuess (int randNum){
        ...
        for(i=1; i<=5;i++){
            ...
            if(guessNum == randNum) {System.out.println("You got it !!!");break;}
            else if(guessNum<randNum) System.out.println("Your number is too low");
            else System.out.println("Your number is too high");
        }
        if(guessNum != randNum) System.out.println("Bulamadin dostum !!!");
