...
public class Methods_FizzBuzz {
   ...
   "Buzz", and for multiples of both 3 and 5 use "FizzBuzz". In Java, String.valueOf(xxx) will make the String form of an int
    ...
    public static String[] fizzBuzz(int start, int end) {
        String[] arrStr= new String[end-start];
        for (int i = start; i < end; i++) {
            arrStr[i-start]="";
            if(i%3==0) arrStr[i-start]+="Fizz";
            if(i%5==0) arrStr[i-start]+="Buzz";
            if(i%3!=0 && i%5!=0) arrStr[i-start]=String.valueOf(i);
        }
        return arrStr;
    }

    public static void main(String[] args) {
        System.out.println("Arrays.toString(fizzBuzz(15, 100)) = " + Arrays.toString(fizzBuzz(15, 100)));
    }
